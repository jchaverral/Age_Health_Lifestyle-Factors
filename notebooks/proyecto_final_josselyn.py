...
plt.title('edades genero', fontsize=12, fontweight='bold', pad=20)
#plt.xlabel(f'{grupo}', fontsize=10)
plt.ylabel('Cantidad', fontsize=10)
...
plt.title('estres edades', fontsize=12, fontweight='bold', pad=20)
#plt.xlabel(f'{grupo}', fontsize=10)
plt.ylabel('Cantidad', fontsize=10)
for i in range(len(categorias1)):
...
plt.title('estres genero', fontsize=12, fontweight='bold', pad=20)
#plt.xlabel(f'{grupo}', fontsize=10)
plt.ylabel('Cantidad', fontsize=10)
for i in range(len(categorias1)):
  plt.text(x[i]- width/2, valores1[i]+0.5, str(valores1[i]),  rotation=90, ha='center', va='bottom', fontsize=10, color='black')
